...
class RtController extends Controller
{
    ...
    {
        $this->assertPengurusBelongsToRt($penguru, $rt);
    ...
    private function assertPengurusBelongsToRt(RtRwPengurus $penguru, Rt $rt): void
    {
        abort_if((int) $penguru->rt_id !== (int) $rt->id, 404);
    }
}
