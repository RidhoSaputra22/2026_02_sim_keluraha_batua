<x-layouts.app :title="'Data Kelahiran'">
    <x-slot:header>
        <x-layouts.page-header title="Data Kelahiran" description="Kelola pencatatan kelahiran penduduk">
            <x-slot:actions>
                <x-ui.import-export-buttons module="kelahiran" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('kependudukan.kelahiran.destroy', $k) }}', message: 'Hapus data kelahiran \u0022{{ $k->nama_bayi }}\u0022?' })">
