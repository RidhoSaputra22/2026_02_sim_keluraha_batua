<x-layouts.app :title="'Tambah Penduduk'">
    ...
    <x-ui.card class="">
        <form method="POST" action="{{ route('kependudukan.penduduk.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <x-ui.select name="jenis_kelamin" label="Jenis Kelamin" required
                    :options="['L' => 'Laki-laki', 'P' => 'Perempuan']" selected="{{ old('jenis_kelamin') }}" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <x-ui.select name="status_data" label="Status Data"
                    ...
                    selected="{{ old('status_data', 'aktif') }}" />
            </div>
