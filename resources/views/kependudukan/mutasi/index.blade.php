<x-layouts.app :title="'Mutasi Penduduk'">
    <x-slot:header>
        <x-layouts.page-header title="Mutasi Penduduk" description="Kelola data mutasi penduduk (pindah & datang)">
            <x-slot:actions>
                <x-ui.import-export-buttons module="mutasi" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('kependudukan.mutasi.destroy', $m) }}', message: 'Hapus data mutasi ini?' })">
