...
<div class="peta-sidebar w-full lg:w-80 xl:w-96 bg-base-100 border-t lg:border-t-0 lg:border-l border-base-200 flex flex-col">
    ...
    <div class="p-4 border-b border-base-200 flex-shrink-0">
        <div class="flex items-center justify-between">
            ...
            <button x-show="selectedRw" @click="resetView()"
                class="btn btn-ghost btn-xs btn-circle" title="Kembali">
