...
<div class="flex-1 relative">
    ...
    <div class="absolute top-3 left-3 z-[1000] flex gap-1.5">
        <button class="btn btn-xs shadow-md"
            :class="showKelurahan ? 'btn-primary' : 'btn-ghost bg-base-100'"
            @click="toggleKelurahan()"
        ...
        <button class="btn btn-xs shadow-md"
            :class="showLabels ? 'btn-primary' : 'btn-ghost bg-base-100'"
            @click="toggleLabels()"
            title="Label RW">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
