<x-layouts.app :title="'Daftar Usaha'">
    <x-slot:header>
        <x-layouts.page-header title="Daftar Usaha" description="Kelola data usaha UMKM/PK5 di kelurahan">
            <x-slot:actions>
                <x-ui.import-export-buttons module="usaha" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('usaha.destroy', $u) }}', message: 'Hapus data usaha ini?' })">
