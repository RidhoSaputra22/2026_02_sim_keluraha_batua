<x-layouts.app :title="'Data Keluarga'">
    <x-slot:header>
        <x-layouts.page-header title="Data Kartu Keluarga" description="Kelola data kartu keluarga">
            <x-slot:actions>
                <x-ui.import-export-buttons module="keluarga" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('kependudukan.keluarga.destroy', $kk) }}', message: 'Hapus data keluarga ini?' })">
