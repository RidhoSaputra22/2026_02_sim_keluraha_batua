<x-layouts.app :title="'Fasilitas Kesehatan'">
    <x-slot:header>
        <x-layouts.page-header title="Fasilitas Kesehatan" description="Kelola data fasilitas kesehatan di wilayah kelurahan">
            <x-slot:actions>
                <x-ui.import-export-buttons module="faskes" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('data-umum.faskes.destroy', $item) }}', message: 'Hapus data faskes ini?' })">
