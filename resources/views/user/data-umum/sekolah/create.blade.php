    ...
    <x-ui.card>
        <form method="POST" action="{{ route('data-umum.sekolah.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <x-ui.select label="Jenjang" name="jenjang" placeholder="Pilih Jenjang" :options="['PAUD' => 'PAUD', 'TK' => 'TK', 'SD' => 'SD', 'SMP' => 'SMP', 'MTs' => 'MTs', 'SMA' => 'SMA', 'SLTA' => 'SLTA', 'SMK' => 'SMK', 'Perguruan Tinggi' => 'Perguruan Tinggi']" selected="{{ old('jenjang') }}" />
