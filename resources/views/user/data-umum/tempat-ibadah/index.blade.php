<x-layouts.app :title="'Tempat Ibadah'">
    <x-slot:header>
        <x-layouts.page-header title="Tempat Ibadah" description="Kelola data tempat ibadah di wilayah kelurahan">
            <x-slot:actions>
                <x-ui.import-export-buttons module="tempat-ibadah" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('data-umum.tempat-ibadah.destroy', $item) }}', message: 'Hapus data ini?' })">
