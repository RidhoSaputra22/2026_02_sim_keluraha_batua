<x-layouts.app :title="'Data Kendaraan'">
    <x-slot:header>
        <x-layouts.page-header title="Data Kendaraan" description="Kelola data kendaraan kelurahan">
            <x-slot:actions>
                <x-ui.import-export-buttons module="kendaraan" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('data-umum.kendaraan.destroy', $item) }}', message: 'Hapus data kendaraan ini?' })">
