<x-layouts.app :title="'Tambah Pengurus RT/RW'">
    <x-slot:header>
        <x-layouts.page-header title="Tambah Pengurus RT/RW" description="Tambah data pengurus RT atau RW baru">
            <x-slot:actions>
    ...
    <x-ui.card>
        <form method="POST" action="{{ route('master.pengurus.store') }}">
            ...
            <div x-data="{ mode: '{{ old('assign_user_mode', 'none') }}' }" class="space-y-4 mb-6">
            ...
            <div class="flex justify-end gap-2 mt-6 border-t pt-4">
                ...
                <x-ui.button type="primary" :isSubmit="true">Simpan Data Pengurus</x-ui.button>
            </div>
        </form>
    </x-ui.card>
</x-layouts.app>
