<x-layouts.app :title="'Data Wilayah RT/RW'">
    <x-slot:header>
        <x-layouts.page-header title="Data Wilayah RT/RW" description="Kelola data RT dan RW">
            <x-slot:actions>
                <x-ui.import-export-buttons module="wilayah" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('master.wilayah.destroy', $w) }}', message: 'Hapus data wilayah ini?' })">
