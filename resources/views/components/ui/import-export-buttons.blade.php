{{--
    ...
    Renders export & import buttons for use in page-header actions.

    @param string $module - The import-export module slug (e.g., 'penduduk', 'faskes')
--}}

@props(['module'])

<div class="dropdown dropdown-end">
    <div tabindex="0" role="button" class="btn btn-sm btn-outline btn-info gap-1">
    ...
    <ul tabindex="0" class="dropdown-content z-[1] menu menu-sm p-2 shadow-lg bg-base-100 rounded-box w-52 border border-base-300">
        <li>
            <a href="{{ route('import-export.export', $module) }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                Export Data
            </a>
        </li>
        <li>
            <a href="{{ route('import-export.import', $module) }}">
        ...
        <li>
            <a href="{{ route('import-export.template', $module) }}">
