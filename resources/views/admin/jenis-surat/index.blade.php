<x-layouts.app :title="'Jenis Surat'">
    <x-slot:header>
            ...
            <table class="table table-zebra">
                <thead>
                    <tr>
                        ...
                        <th class="w-32 text-center">Jumlah Surat</th>
                ...
                <tbody>
                    ...
                    <tr class="hover">
                        <td class="text-sm text-base-content/60">{{ $jenisSurat->firstItem() + $loop->index }}</td>
                        <td>
                            <div class="font-medium">{{ $js->nama }}</div>
                        </td>
                        <td class="text-center">
                            <span class="badge badge-ghost badge-sm">{{ $js->surats_count ?? 0 }}</span>
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center py-8 text-base-content/60">Tidak ada data jenis surat.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
