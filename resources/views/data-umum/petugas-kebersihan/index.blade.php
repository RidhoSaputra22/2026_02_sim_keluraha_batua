<x-layouts.app :title="'Petugas Kebersihan'">
    <x-slot:header>
        <x-layouts.page-header title="Petugas Kebersihan" description="Kelola data petugas kebersihan kelurahan">
            <x-slot:actions>
                <x-ui.import-export-buttons module="petugas-kebersihan" />
                    ...
                    <tr class="hover">
                        ...
                        <td>
                            <div class="flex justify-end gap-1">
                                ...
                                <x-ui.button type="error" size="xs" :outline="true" @click="$dispatch('confirm-delete', { action: '{{ route('data-umum.petugas-kebersihan.destroy', $item) }}', message: 'Hapus data petugas ini?' })">
