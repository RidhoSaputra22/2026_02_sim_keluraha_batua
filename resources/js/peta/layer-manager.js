window.layerManager = function layerManager() {
    const LAYER_ROUTES = window.LAYER_ROUTES;
    const INITIAL_LAYERS = window.INITIAL_LAYERS;
    const LAYERS_GEOJSON = window.LAYERS_GEOJSON;
    return {
        // ─── State ─────────────────────────────────────
        loading: true,
        layers: [],
