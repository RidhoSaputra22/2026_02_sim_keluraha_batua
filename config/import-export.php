...
return [
    ...
    'penduduk' => [
        ...
        'with'        => ['keluarga', 'rt.rw'],
        'columns'     => ['nik', 'nama', 'jenis_kelamin', 'gol_darah', 'agama', 'status_kawin', 'pendidikan', 'alamat', 'status_data', 'no_kk', 'rt_rw'],
        'headers'     => ['NIK', 'Nama', 'Jenis Kelamin', 'Gol Darah', 'Agama', 'Status Kawin', 'Pendidikan', 'Alamat', 'Status Data', 'No KK', 'RT/RW'],
        'required'    => ['nik', 'nama', 'jenis_kelamin'],
        'resolvers'   => [
            'no_kk' => 'keluarga.no_kk',
            'rt_rw' => 'rt_rw_label',
        ],
        'import_columns' => ['nik', 'nama', 'jenis_kelamin', 'gol_darah', 'agama', 'status_kawin', 'pendidikan', 'alamat', 'status_data'],
        'import_headers' => ['NIK', 'Nama', 'Jenis Kelamin', 'Gol Darah', 'Agama', 'Status Kawin', 'Pendidikan', 'Alamat', 'Status Data'],
    ],
