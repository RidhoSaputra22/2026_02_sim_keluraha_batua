...
return [
    ...
    'pbb' => [
        ...
        'with'        => ['kelurahan', 'rw', 'rt'],
        'columns'     => ['no', 'nama_wajib_pajak', 'rw', 'rt', 'objek_pajak', 'nob', 'beban', 'status'],
        'headers'     => ['NO', 'NAMA WAJIB PAJAK', 'RW', 'RT', 'OBJEK PAJAK', 'NOP', 'BEBAN (Rp)', 'STATUS (Lunas/Belum)'],
        'required'    => ['nama_wajib_pajak', 'rw', 'rt', 'nob'],
        'resolvers'   => [
            'no' => 'pbb_no',
            'rw' => 'rw',
            'rt' => 'rt',
        ...
        'import_columns' => ['no', 'nama_wajib_pajak', 'rw', 'rt', 'objek_pajak', 'nob', 'beban', 'status'],
        'import_headers' => ['NO', 'NAMA WAJIB PAJAK', 'RW', 'RT', 'OBJEK PAJAK', 'NOP', 'BEBAN (Rp)', 'STATUS (Lunas/Belum)'],
        'unique_by' => ['nob'],
        'example_row' => ['1', 'Tamrin Marewa', '05', '01', 'Jl. Bontobila 2 RT.01 RW.05', '73.71.140.004.001-0015.0', '77202', 'BELUM'],
    ],
